...
python -u run.py   --task_name anomaly_detection_uae   --is_training 1   --root_path ./dataset/anomaly_detection/WADI/WADI2019_power_transformed  --model_id TimesNet_UAE_full_v1.0  --model TimesNet   --data WADI   --features S   --seq_len 30   --pred_len 30 --label_len 30   --d_model 32   --d_ff 32   --e_layers 2   --enc_in 123  --c_out 1   --batch_size 128   --train_epochs 1  --num_workers 0 --n_heads 8

python -u run.py   --task_name anomaly_detection_uae   --is_training 1   --root_path ./dataset/anomaly_detection/WADI/WADI2019_power_transformed  --model_id Informer_UAE_full_v1.0  --model Informer   --data WADI   --features S   --seq_len 30   --pred_len 30 --label_len 30   --d_model 32   --d_ff 32   --e_layers 2   --enc_in 123  --c_out 1   --batch_size 128   --train_epochs 1  --num_workers 0 --n_heads 8
